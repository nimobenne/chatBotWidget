...
function TestimonialCard({ quote, name, shop }: Testimonial) {
  return (
    <article className="w-[280px] shrink-0 rounded-xl border border-border/80 bg-card/80 p-4 backdrop-blur">
  ...
  return (
    <section className="rounded-2xl border border-border bg-card/40 p-5 md:p-6">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.18em] text-emerald-300">Trusted by barbers</p>
          <h3 className="mt-1 text-xl font-semibold text-foreground">What owners say after going live</h3>
        </div>
        <Badge variant="secondary" className="border-emerald-500/50 bg-emerald-500/15 text-emerald-100">
          4.9 average
        </Badge>
      </div>
      <div className="relative overflow-hidden">
        ...
        <div className="flex w-max gap-4 py-1 motion-safe:animate-marquee motion-reduce:translate-x-0 motion-reduce:animate-none">
